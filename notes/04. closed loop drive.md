...
Running a pretrained agent based on [TransfuserV6 agent](https://ln2697.github.io/lead/docs/transfuser_versions#transfuser-v6-arxiv-report), using the  [PCLA](https://github.com/MasoudJTehrani/PCLA) (Pretrained CARLA Leaderboard Agents).

The transfusion based agent successfully avoids a pedestrian:
![Transfusion Drive](../data/illustrations/pcla_transfusion_drive.gif)
