...
I setup cursor to SSH into the runpod instance, which made writing and running scripts that much quicker.

## Testing a CARLA render
Tested rendering a single image based on `capture_one_png.py`

![First CARLA render](../data/renders/first_render.png)
