...
Fixed delta seconds: 0.1
```
This configuration enables deterministic world stepping, 0.1 second at a time.

Previous versions used random initial conditions with a fixed seed, although I simplified the approach and removed that once I had a good enough setup. 
